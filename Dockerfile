...
RUN apt-get install -y python-pip python-ldap python-yaml nano vim alien libaio1 python3 python3-pip heirloom-mailx pwgen dnsutils samba python3-magic python-magic
